...
• Java: JDK 8, 11, or 17.
3. How to Run 
1.	Download & Extract: Unzip the project folder to your Desktop or C:\ drive.
2.	Open Project: * If you have NetBeans, go to File > Open Project and select the folder.
